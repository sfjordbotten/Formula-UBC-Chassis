...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.75\textwidth]{"Figures/LLTDvsRSD".png}
	\end{center}
...
% REF? RSD = weight dist + 2-3%, historic weight dist 48-52%, SUS adjustability ~6% => desired adjustability min 5% (weight dist + 2-3% = 50-55%) => dLLTD/dRSD 5/6=83.3333333%4

\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.75\textwidth]{"Figures/slopeVsChassisK".png}
	\end{center}
